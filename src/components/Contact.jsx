...
const Contact = () => {
    return (
        <section id="contact" className="min-h-screen bg-white text-black flex items-center px-6 md:px-20 py-20" style={{ backgroundImage: `url(${workspaceBg})`, backgroundSize: "cover", backgroundPosition: "center" }}>
